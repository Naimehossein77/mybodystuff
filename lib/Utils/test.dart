...
void main() {
  ...
  var textRecords = [ndef.TextRecord(text: 'hi')];
  print(textRecords.first.toString());
  ...
  print('===================');
  print('original payload: ' + origPayload.toString());
  print(String.fromCharCodes(origPayload));
